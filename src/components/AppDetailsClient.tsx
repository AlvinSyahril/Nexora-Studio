  ...
  return (
    <div className={styles.showcaseWrapper} ref={wrapperRef}>
      ...
      <nav className={`${styles.container} ${styles.nav}`} data-animate="nav">
        ...
        <DownloadButton href="https://github.com/AlvinSyahril/Nexora-Studio/releases/download/v2.1.3-GTD/Get-Things-Done.apk" className={styles.navBtn}>Download App</DownloadButton>
      </nav>
      ...
      <section className={`${styles.container} ${styles.hero}`}>
        <div className={styles.heroText}>
          ...
          <div className={styles.heroActions} data-animate="hero-element">
            <DownloadButton href="https://github.com/AlvinSyahril/Nexora-Studio/releases/download/v2.1.3-GTD/Get-Things-Done.apk" className={styles.btnPrimary}>Get Started Free</DownloadButton>
            <a href="#features" className={styles.btnSecondary}>Explore Features</a>
          </div>
        </div>
        <div className={styles.heroVisual} data-animate="hero-element">
      ...
      <footer className={styles.footer} data-animate="feature">
        ...
        <div className={styles.container}>
          ...
          <DownloadButton href="https://github.com/AlvinSyahril/Nexora-Studio/releases/download/v2.1.3-GTD/Get-Things-Done.apk" className={styles.footerBtn}>Download Get Things Done</DownloadButton>
          <p className={styles.footerCopy}>© 2026 Nexora Studio. All rights reserved.</p>
        </div>
      </footer>
    </div>
