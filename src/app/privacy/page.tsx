  ...
  return (
    <div className="container" style={{ padding: "6rem 1.5rem", maxWidth: "800px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "2rem", color: "var(--foreground)", opacity: 0.9, lineHeight: 1.7, fontSize: "1.05rem" }}>
        ...
        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "var(--foreground)", marginBottom: "1rem" }}>1. Introduction</h2>
        ...
        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "var(--foreground)", marginBottom: "1rem" }}>2. The Data We Collect About You</h2>
        ...
        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "var(--foreground)", marginBottom: "1rem" }}>3. How We Use Your Personal Data</h2>
        ...
        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "var(--foreground)", marginBottom: "1rem" }}>4. Data Security</h2>
          <p>We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorised way, altered or disclosed. In addition, we limit access to your personal data to those employees, agents, contractors and other third parties who have a business need to know.</p>
        </section>

        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "var(--foreground)", marginBottom: "1rem" }}>5. Contact Me</h2>
