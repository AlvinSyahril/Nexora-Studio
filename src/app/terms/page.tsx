  ...
  return (
    <div className="container" style={{ padding: "6rem 1.5rem", maxWidth: "800px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "2rem", color: "var(--foreground)", opacity: 0.9, lineHeight: 1.7, fontSize: "1.05rem" }}>
        ...
        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "#fff", marginBottom: "1rem" }}>1. Acceptance of Terms</h2>
        ...
        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "#fff", marginBottom: "1rem" }}>2. Use License</h2>
        ...
        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "#fff", marginBottom: "1rem" }}>3. Disclaimer</h2>
        ...
        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "#fff", marginBottom: "1rem" }}>4. Limitations</h2>
        ...
        <section>
          <h2 className="display-font" style={{ fontSize: "1.5rem", color: "#fff", marginBottom: "1rem" }}>5. Revisions and Errata</h2>
